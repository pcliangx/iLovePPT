...
## builder/visual_report_r1.md 应有(iloveppt Step 4 产出 · 原 designer 流程并入)
...
- **patterns_searched / patterns_matched / patterns_applied**(library-first 协议要求,见 pipeline-protocol §13.6)
