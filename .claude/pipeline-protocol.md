...
| 6 | builder `dispatch_audience` | `Task(audience, args={rendered_dir: "builder/deck_v1_render/", deck_plan_path: ..., builder_visual_edits: [...], audience: <type>, top_recommendation: ..., brief, content_md_path: ..., brief_md_path: ..., claims_path: "author/deck_v1_claims.yaml"(有则传), report_path: "audience/deck_v1_audience.r{R}.md"})`(入参含 spot-check 所需 deck_plan_path + builder_visual_edits + content_md_path + brief_md_path + claims_path) | `delivered` 或 `needs_*` |
