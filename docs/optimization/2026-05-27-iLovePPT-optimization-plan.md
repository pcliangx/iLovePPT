...
| 2026-05-27 | **P3 phase 3 done** | ✓ 新 4 / 累计 18 / 22 | 4 agent 并行 · 2 个 socket 中断但产物落盘 · P3-6 SQLite WAL(并发不锁)· P3-10 中英文混排(mixed_lang_text + tokenize_mixed)· P3-13 deck_diff.py 4 类语义 diff · P3-20 .gitignore.lint 5 类检查 · 179 tests pass(+31)· bench 7/7 hit 维持 |
| TBD | P3 剩余 4 项 | ☐ | P3-4 hosted embed / P3-11 多语言 / P3-12 a11y / P3-16 layout CV(规模大或需 specific use case · 视需求触发)|
